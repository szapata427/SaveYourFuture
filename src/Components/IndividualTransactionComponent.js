        ...
        return(
            <React.Fragment>
                ...
                <tr className="transaction-table-rows">
                    <td className="transactions-span-per-value">${checkIfAmountHasTwoDecimals(this.props.transaction.Amount) ? this.props.transaction.Amount: this.props.transaction.Amount + ".00"}</td>
